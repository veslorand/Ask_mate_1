...
def list_questions():
    ...
    return render_template("question_list.html", all_question=sorted_questions_by_date, header=data_handler.DATA_HEADER)
...
def add_question():
    ...
    return render_template("add_new_question.html", header=data_handler.DATA_HEADER)
...
def question(question_id):
    ...
    return render_template("answer_list.html", question=line, header=data_handler.QUESTION_HEADER, all_answer=sorted_answer_by_vote)
